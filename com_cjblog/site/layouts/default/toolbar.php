	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="navbar-inner">
			<div class="navbar-header">
				...
				<a class="brand navbar-brand" href="<?php echo JRoute::_(CjBlogHelperRoute::getCategoriesRoute());?>">
					<?php echo JText::_('COM_CJBLOG_LABEL_HOME');?>
				</a>
			</div>
			<div class="collapse nav-collapse navbar-collapse navbar-responsive-collapse" id="cb-navbar-collapse">
				<?php if(!$user->guest):?>
