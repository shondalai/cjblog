...
?>
<div class="m-0 p-0" <?php echo $microdata->displayScope(); ?>>
    <div class="row">
        <div class="col-md-12">
            <div class="profile-header mb-3">
                <h1 class="cjheader my-0 border-bottom">
        ...
        <div class="col-md-3">
            <div class="profile-avatar">
                <a <?php echo $microdata->property( 'url' )->display(); ?> href="<?php echo $profileUrl; ?>" class="thumbnail margin-bottom-5">
                    <img <?php echo $microdata->property( 'image' )->display(); ?>
                    ...
                    <div class="col-md-12">
                        <div id="profile-actions">
							...
							<?php if ( $params->get( 'gdpr_delete_profile' ) ): ?>
                                <a class="btn btn-danger btn-sm" href="#" onclick="return false;" data-toggle="modal" data-target="#confirm-delete-profile">
                    ...
                    <table class="table table-striped table-hover table-condensed">
						...
						<?php if ( $params->get( 'profile_show_gender', 1 ) == 1 ): ?>
                            <tr>
                                ...
                                <td><?php echo $microdata->content( JText::sprintf( 'COM_CJBLOG_PROFILE_GENDER_' . ( (int) $item->gender ) ) )
								                         ->property( 'gender' )
								                         ->display(); ?></td>
                            </tr>
						<?php endif; ?>
