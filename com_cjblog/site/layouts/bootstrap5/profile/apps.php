	...
	<ul class="nav nav-tabs" role="tablist" style="border-bottom: none;">
		...
		for($i = 0; $i < $maxTabs; $i++)
		{
			...
			<li class="nav-item" role="presentation">
				<a href="<?php echo JRoute::_($profileUri.'&tab='.$tabs[$i]->id);?>" class="nav-link<?php echo $tabs[$i]->id == $apps->id ? ' active' : ' ';?>">
		...
		{
			?>
			<li role="presentation" class="nav-item dropdown<?php echo ! $activated ? ' active' : '';?>">
