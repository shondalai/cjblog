		...
		<form action="<?php echo JRoute::_('index.php');?>" method="post">
				...
				<div class="col-md-12">
					<div class="card card-<?php echo $theme;?>">
						<div class="card-header">
							<div class="card-title"><?php echo JText::_('COM_CJBLOG_LABEL_KEYWORDS');?></div>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-8">
			...
			<div class="row mb-3">
				<div class="col-md-6">
					<div class="card card-<?php echo $theme;?>">
						<div class="card-header">
							<div class="card-title"><?php echo JText::_('COM_CJBLOG_SEARCH_OPTIONS');?></div>
						</div>
						<div class="card-body">
				...
				<div class="col-md-6">
					<div class="card card-<?php echo $theme;?>">
						<div class="card-header">
							<div class="card-title"><?php echo JText::_('COM_CJBLOG_LABEL_CATEGORIES');?></div>
						</div>
						<div class="card-body">
							<?php 
							$nocat = new JObject();
