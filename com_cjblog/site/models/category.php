 ...
 * @since  1.0.0
 */
class CjBlogModelCategory extends ListModel
{
	/**
	 * Category items data
	 *
	...
	protected function _buildContentOrderBy()
	{
		...
		$secondary        = CjBlogHelperQuery::orderbySecondary($articleOrderby, $articleOrderDate, $this->getDbo()) . ', ';
		$primary          = CjBlogHelperQuery::orderbyPrimary($categoryOrderby);
