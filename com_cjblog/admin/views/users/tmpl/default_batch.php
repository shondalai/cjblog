...
$options = array(
	JHtml::_('select.option', 'add', JText::_('COM_CJBLOG_BATCH_ADD')),
	JHtml::_('select.option', 'del', JText::_('COM_CJBLOG_BATCH_DELETE')),
	JHtml::_('select.option', 'set', JText::_('COM_CJBLOG_BATCH_SET'))
);

// Create the reset password options.
$resetOptions = array(
	JHtml::_('select.option', '', JText::_('COM_CJBLOG_NO_ACTION')),
...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_CJBLOG_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body modal-batch">
		<label><?php echo JText::_('COM_CJBLOG_REQUIRE_PASSWORD_RESET'); ?></label>
