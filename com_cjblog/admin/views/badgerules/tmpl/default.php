...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cjblog&task=badgerules.saveOrderAjax&tmpl=component';
				...
				?>
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id; ?>">
						...
						<td class="has-context">
							<div class="pull-left">
								<?php if ($item->checked_out) : ?>
									<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'badgerules.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_cjblog&task=badgerule.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<?php echo $item->title; ?>
									</a>
								<?php endif; ?>
						...
						<td>
							...
							<img alt="<?php echo $this->escape($item->title)?>" src="<?php echo JUri::root(false).$item->icon;?>" title="<?php echo $this->escape($item->badge);?>">
							<?php else :?>
							<span class="badge <?php echo $item->css_class;?>"><i class="fa fa-dot-circle-o"></i> <?php echo $this->escape($item->badge);?></span>
							<?php endif;?>
						</td>
