			...
			:
				...
				?>
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id; ?>">
						...
						<td class="center">
							<div class="btn-group">
								<?php echo JHtml::_('jgrid.published', $item->published, $i, 'badges.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
								<?php
									// Create dropdown items
									$action = $archived ? 'unarchive' : 'archive';
									JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'badges');
						...
						<td class="has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_cjblog&task=badge.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<?php echo $item->title; ?>
									</a>
								<?php endif; ?>
						...
						<td>
							...
							<img alt="<?php echo $this->escape($item->title)?>" src="<?php echo JUri::root(false).$item->icon;?>" title="<?php echo $this->escape($item->title);?>">
							<?php else :?>
							<span class="badge <?php echo $item->css_class;?>"><i class="fa fa-dot-circle-o"></i> <?php echo $this->escape($item->title);?></span>
							<?php endif;?>
						</td>
