...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cjblog&task=badges.saveOrderAjax&tmpl=component';
...
<div id="cj-wrapper" class="<?php echo $rowClass;?>">
	...
	<div id="j-main-container">
		<form action="<?php echo JRoute::_('index.php?option=com_cjblog&view=badgerules'); ?>" method="post" name="adminForm" id="adminForm">
    		<?php
    		// Search tools bar
						...
						<td class="center">
							...
							if($item->published == 3)
							{
								...
								<a class="btn btn-micro hasTooltip" href="javascript:void(0);" 
									onclick="return listItemTask('cb<?php echo $i;?>','reviews.approve')" title="" data-original-title="<?php echo JText::_('COM_CJBLOG_APPROVE_ARTICLE')?>">
									<span class="icon-publish"></span>
								</a>
								<a class="btn btn-micro hasTooltip" href="javascript:void(0);" 
									onclick="return listItemTask('cb<?php echo $i;?>','reviews.disapprove')" title="" data-original-title="<?php echo JText::_('COM_CJBLOG_DISAPPROVE_ARTICLE')?>">
							...
							{
								?>
								<a href="javascript:void(0);" class="hasTooltip" data-original-title="<?php echo JText::_('JPUBLISHED')?>"><span class="icon-publish"></span></a>
								<?php 
							}
							else if($item->published == 0)
							{
								?>
								<a href="javascript:void(0);" class="hasTooltip" data-original-title="<?php echo JText::_('JUNPUBLISHED')?>"><span class="icon-unpublish"></span></a>
								<?php 
							}
							?>
						</td>
						<td class="has-context">
							<div class="pull-left">
								<?php if ($item->checked_out) : ?>
									<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'badges.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_cjblog&task=review.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
										<?php echo $item->title; ?>
									</a>
								<?php endif; ?>
