...
<script type="text/javascript">
  Joomla.submitbutton = function (task) {
    if (task == 'profile.cancel' || document.formvalidator.isValid(document.getElementById('item-form'))) {
		...
		if ( CJBLOG_MAJOR_VERSION < 4 )
		{
			echo $this->form->getField( 'about' )->save();
		}
		?>
				...
				<div class="control-group center text-center">
					<div style="width: 256px;">
						...
						<div id="avatar-controls" class="label label-inverse margin-bottom-10">
							...
							<a href="#" id="rotate_left" title="Rotate left" data-toggle="tooltip" onclick="return false;"><i class="fa fa-undo"></i></a>
							...
							<a href="#" id="rotate_right" title="Rotate right" data-toggle="tooltip" onclick="return false;"><i class="fa fa-redo"></i></a>
						</div>
