...
class JHtmlUsers
{
	...
	{
		$title = JText::_('COM_CJBLOG_ADD_NOTE');
	...
	public static function filterNotes($count, $userId)
	{
		...
		$title = JText::_('COM_CJBLOG_FILTER_NOTES');

		return '<a href="' . JRoute::_('index.php?option=com_users&view=notes&filter_search=uid:' . (int) $userId) . '">'
			. JHtml::_('image', 'admin/filter_16.png', 'COM_CJBLOG_NOTES', array('title' => $title), true) . '</a>';
	}
	...
	public static function notes($count, $userId)
	{
		...
		$title = JText::plural('COM_CJBLOG_N_USER_NOTES', $count);
		...
		if ($self)
		{
			$states = array(
				1 => array(
					'task'				=> 'unblock',
					'text'				=> '',
					'active_title'		=> 'COM_CJBLOG_USER_FIELD_BLOCK_DESC',
					'inactive_title'	=> '',
					'tip'				=> true,
				...
				0 => array(
					...
					'text'				=> '',
					'active_title'		=> '',
					'inactive_title'	=> 'COM_CJBLOG_USERS_ERROR_CANNOT_BLOCK_SELF',
					'tip'				=> true,
		...
		else
		{
			$states = array(
				1 => array(
					'task'				=> 'unblock',
					'text'				=> '',
					'active_title'		=> 'COM_CJBLOG_TOOLBAR_UNBLOCK',
					'inactive_title'	=> '',
					'tip'				=> true,
					'active_class'		=> 'unpublish',
					'inactive_class'	=> 'unpublish'
	...
	public static function activateStates()
	{
		$states = array(
			1	=> array(
				'task'				=> 'activate',
				'text'				=> '',
				'active_title'		=> 'COM_CJBLOG_TOOLBAR_ACTIVATE',
				'inactive_title'	=> '',
				'tip'				=> true,
				'active_class'		=> 'unpublish',
				'inactive_class'	=> 'unpublish'
			...
			0	=> array(
				...
				'text'				=> '',
				'active_title'		=> '',
				'inactive_title'	=> 'COM_CJBLOG_ACTIVATED',
				'tip'				=> true,
				'active_class'		=> 'publish',
				'inactive_class'	=> 'publish'
			)
